...
## Use cases
When I order a drink and it can be delivered because of a shortage, I want to seend a message to the coffee machine console that indicates me the shortage and that a notification has been sent

## Implementation details
You can take advantages of the following 2 collaborators of the coffee machine:
